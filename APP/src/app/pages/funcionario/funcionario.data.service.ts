...
export class DataServiceFuncionario {
  ...
  getFuncionarios(): Observable<any[]> {
    ...
    return this.http.get<any[]>(url).pipe(
      tap((funicionarios) => console.log('fetched funcionarios')),
  ...
  postFuncionariosInclusao(
    ...
    const url = `${apiUrl}/funcionarioinclusao`;
  ...
  postFuncionariosExclusao(selecionado): Observable<any> {
    let x = [];
    x = selecionado;
